...
public class Dog implements Pet {
     ...
     *  *** Бобик ***  лает гааав! 13-ноя-2013 Срdat
     * Мышь пищит.
     *  *** Шарик ***  спит.
     *
        ...
        class DogPet extends SuperDog implements Sayable {
            ...
            public String say() {
                ...
                if (i < 1) return getSuperQuotes() + name + getSuperQuotes() + " спит.";
                    ...
                    StringBuilder sb = new StringBuilder(getSuperQuotes() + name + getSuperQuotes() + " лает г");
                    for (int j = 0; j < i; j++) {
                        sb.append("а");
                    }
                    sb.append("в!").append(" ").append(formatter.format(date));
                    return sb.toString();
                }
            }
        }
