        ...
        list.sort((stock1, stock2) -> {
            ...
            if (s1.compareTo(s2) == 0) {
                ...
                if (d2.compareTo(d1) == 0) {
                    ...
                    double open2 = !stock1.containsKey("open") ? 0 : ((double) stock1.get("open"));
                    double last2 = !stock1.containsKey("last") ? 0 : ((double) stock1.get("last"));
                    double change2 = !stock1.containsKey("change") ? 0 : ((double) stock1.get("change"));
                    double profit1 = open1 - last1 + change1;
                    double profit2 = open2 - last2 + change2;
